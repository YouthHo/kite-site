...
| 文件A | 文件B | 冲突 | 值A | 值B |
| --- | --- | --- | --- | --- |
| scenes.json:12 | characters.json:9 | 名场面集数超出相关角色出场区间 | ep=14 | 程真儿 episodes=[1,5] |
...
| relationships.json:37 | characters.json | activeEra 超出两端出场交集 | [10,33] | 交集=[2,15] |
| relationships.json:38 | characters.json | activeEra 超出两端出场交集 | [6,26] | 交集=[1,5] |
...
| relationships.json:73 | characters.json | activeEra 超出两端出场交集 | [10,33] | 交集=[2,15] |
...
| relationships.json:86 | characters.json | activeEra 超出两端出场交集 | [6,26] | 交集=[2,5] |
