...
<template>
  <div class="absolute inset-0 z-[75] flex items-center justify-center p-4" role="dialog" aria-label="操作帮助与图例说明">
    ...
    <div class="relative w-full max-w-[520px] max-h-[86%] overflow-y-auto bg-[#0e0e0e] border border-[#2a2520] p-6">
      ...
      <div class="mt-5 font-mono text-[10px] tracking-[0.3em] text-[#a89f8e]">基本操作</div>
      <ul class="mt-2 space-y-1.5 text-[12px] leading-6 text-[#a89f8e]">
      ...
      <div class="mt-5 font-mono text-[10px] tracking-[0.3em] text-[#a89f8e]">三种模式</div>
      <ul class="mt-2 space-y-1.5 text-[12px] leading-6 text-[#a89f8e]">
      ...
      <div class="mt-5 font-mono text-[10px] tracking-[0.3em] text-[#a89f8e]">图例语义</div>
      <ul class="mt-2 space-y-1.5 text-[12px] leading-6 text-[#a89f8e]">
      ...
      <div class="mt-5 font-mono text-[10px] tracking-[0.3em] text-[#a89f8e]">时间轴</div>
      <p class="mt-2 text-[12px] leading-6 text-[#a89f8e]">底部集数滑块拖动全剧 46 集：角色按出场时间浮现与消散，边随之形成。播放键自动演化。</p>
    </div>
  </div>
</template>
